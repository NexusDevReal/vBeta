...
local DefaultTheme = {
    Background = Color3.fromRGB(19, 21, 27),
    Surface = Color3.fromRGB(27, 30, 38),
    SurfaceAlt = Color3.fromRGB(34, 38, 48),
    Accent = Color3.fromRGB(109, 90, 255),
    AccentSoft = Color3.fromRGB(89, 74, 214),
    TextPrimary = Color3.fromRGB(245, 246, 250),
    TextSecondary = Color3.fromRGB(185, 191, 205),
    Border = Color3.fromRGB(65, 72, 88),
    Danger = Color3.fromRGB(255, 99, 108),
    Success = Color3.fromRGB(76, 200, 120),
    Shadow = Color3.fromRGB(5, 6, 9),
}
...
local function getGuiParent()
    ...
    local ok, parentOrErr = pcall(function()
...
function Tab:AddLabel(config)
    config = config or {}
    local holder = componentBase(self, 40)
...
function Tab:AddButton(config)
    config = config or {}
    local holder = componentBase(self, 46)
...
function Tab:AddToggle(config)
    config = config or {}
    local holder = componentBase(self, 48)
...
function Tab:AddSlider(config)
    config = config or {}
    local holder = componentBase(self, 64)
...
function Tab:AddDropdown(config)
    config = config or {}
    local holder = componentBase(self, 50)
...
function Tab:AddInput(config)
    config = config or {}
    local holder = componentBase(self, 54)
